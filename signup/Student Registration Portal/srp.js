...
let srpValidation =   () => {
    ...
    if (fatherCnic.value === "" || fatherCnic.value.length !=12  || isNaN(fatherCnic.value)  ) {
        firstName.style="border-color: red";
        firstnameError.innerHTML = "";
        lastName.style="border-color: red";
        lastNameError.innerHTML = "";
        ...
        fatherCnicError.innerHTML = "Fill  this Field. Enter 12 Number Cnic  & not allowed Characters ";
        return false;
    }
    if (fatherPH.value === "" || fatherPH.value.length !=12  || isNaN(fatherPH.value)  ) {
        firstName.style="border-color: red";
        firstnameError.innerHTML = "";
        lastName.style="border-color: red";
        lastNameError.innerHTML = "";
        ...
        fatherPhError.innerHTML = "Fill  this Field. Enter correct phone number with dailing code Number Cnic  & not allowed Characters ";
        return false;
    }
    if (userDob.value === "" ) {
        firstName.style="border-color: red";
...
submitError.innerHTML="Submitting Please Wait....";
 ...
 .then((userCredential) => {
    ...
    // ...
    firebase.database().ref(`crest/students/`+user.uid).child("ProfileData").set(data).then(() => {
