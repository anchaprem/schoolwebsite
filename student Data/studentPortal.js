...
var starCountRef = firebase.database().ref('crest/students/' + userId );
starCountRef.on('value', (snapshot) => {
const data = snapshot.val();
console.log(data)
});

firebase.database().ref(`crest/students/`).child(userId).on('child_added',function(std){
...
// firebase.database().ref(`crest/students/${schoolLevel.value}/${enterGrade.value}`).child(`${
